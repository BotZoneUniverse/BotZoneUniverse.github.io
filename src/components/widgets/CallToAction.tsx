        ...
        <div class="py-12 md:py-20">
          <div class="max-w-3xl mx-auto text-center p-6 rounded-md shadow-xl dark:shadow-none">
            <h2 class="text-4xl md:text-4xl font-bold leading-tighter tracking-tighter mb-4 font-heading">
              <span class="text-[#039de1]">Bot Bliss</span> <br class="block sm:hidden" />
              <span class="text-[#039de1] sm:whitespace-nowrap">
                Telegram Bots
              </span>
            </h2>
            <p class="text-xl text-gray-600 dark:text-slate-400">
              Explore the world of Telegram bots with Bot Bliss. Discover how these bots can enhance your messaging experience. 
            </p>

            <div class="mt-6">
              <a
                class="btn btn-primary mb-4 sm:mb-0 w-full sm:w-auto"
                href="https://t.me/BotZoneUniverse"
                target="_blank"
                rel="noopener"
              >
                BotZone Telegram
